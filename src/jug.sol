...
/**
* @dev The Jug contract computes the stability fee grow graph then tells the Vat to 
* increases the accumulated debt multiplier(rate) for a collateral type 
*/
...
contract Jug {
    ...
    uint256 public base; // Collateral-global, per-second stability fee contribution [ray]
